# CAARMA Baseline Autoresearch Policy

Your task is to improve the CAARMA one-shot paper-reproduction baseline through
...
mixup construction, DDP configuration, or checkpoint-selection metric.
